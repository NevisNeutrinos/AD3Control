...
namespace wf
{
    ...
    public:
        ...
        void generate(Device::Data *device_data, int channel, DwfDigitalOutType function, double frequency, double duty_cycle = 50.0, std::vector<unsigned short> data = std::vector<unsigned short>(), double wait = 0, int repeat = 0, double run_time = 0, DwfDigitalOutIdle idle = DwfDigitalOutIdleInit, bool trigger_enabled = false, TRIGSRC trigger_source = trigsrcNone, bool trigger_edge_rising = true);
